...
const Create = (props) => {
    ...
    const {uid,title, start_time, end_time, daily_break_duration, weekend} = props.shift
    ...
    const onSubmit = async data => {
        if(starttime && endtime){
            ...
            const res = await Requests.Employee.EmployeeShiftUpdate(newdata, uid)
            if(res.status === 200){
                Toast.fire({
                    icon: 'success',
                    title: 'EmployeShift Updated Successfully'
                })
        ...
        >
            <Modal.Header>
                <div className="d-flex">
                    <div><Text className="fs-18 fw-bold mb-0">{t('Update Employee Shift')}</Text></div>
                    ...
                    <div className="row">
                        ...
                        <div className="col-12 col-lg-6">
                            ...
                            <SingleSelect
                                ...
                                default={{value: weekend, label: weekend}}
                            />
                        </div>
                        ...
                        <div className="col-12 col-lg-4">
                            <div className="form-group mb-4">
                                ...
                                <input
                                    ...
                                    defaultValue={daily_break_duration}
                                />
                            </div>
                        </div>
